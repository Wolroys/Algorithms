...
class MSTWApp
{
    ...
    {
        WGraph theWGraph = new WGraph();
        theWGraph.addVertex('A');    // 0  (start for mst)
        theWGraph.addVertex('B');    // 1
        theWGraph.addVertex('C');    // 2
        theWGraph.addVertex('D');    // 3
        theWGraph.addVertex('E');    // 4
        theWGraph.addVertex('F');    // 5

        theWGraph.addEdge(0, 1, 6);  // AB  6
        theWGraph.addEdge(0, 3, 4);  // AD  4
        theWGraph.addEdge(1, 2, 10); // BC 10
        theWGraph.addEdge(1, 3, 7);  // BD  7
        theWGraph.addEdge(1, 4, 7);  // BE  7
        theWGraph.addEdge(2, 3, 8);  // CD  8
        theWGraph.addEdge(2, 4, 5);  // CE  5
        theWGraph.addEdge(2, 5, 6);  // CF  6
        theWGraph.addEdge(3, 4, 12); // DE 12
        theWGraph.addEdge(4, 5, 7);  // EF  7

        System.out.print("Minimum spanning tree: ");
        theWGraph.mstw();            // minimum spanning tree
        System.out.println();
    }  // end main()
}